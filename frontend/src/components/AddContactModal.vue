      ...
      <div class="px-5 pb-6">
        ...
        <div class="flex gap-2">
          <div
            ...
            :class="status === 'error' ? 'border-red-400' : 'border-gray-200 focus-within:border-gray-400'"
          >
        ...
        >
          <span class="shrink-0 mt-0.5 w-5 h-5 rounded-full bg-green-500 flex items-center justify-center">
        ...
        >
          <span class="shrink-0 mt-0.5 w-5 h-5 rounded-full bg-red-500 flex items-center justify-center">
            <svg class="w-3 h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
